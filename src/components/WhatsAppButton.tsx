...
export default function WhatsAppButton() {
  ...
  useEffect(() => {
    ...
    const timer2 = setTimeout(() => setShowTooltip(true), 3000);
    return () => {
      clearTimeout(timer1);
      clearTimeout(timer2);
    };
    ...
    >
      ...
      {showTooltip && (
        <div className="absolute bottom-full right-0 mb-3 animate-fade-in">
          <div className="relative bg-white rounded-2xl shadow-2xl shadow-stone-300/50 p-4 pr-10 max-w-[260px] border border-stone-100">
            <button
            ...
            <p className="text-stone-500 text-xs leading-relaxed">
              Faça seu pedido pelo WhatsApp! Estamos prontos para atender você.
            </p>
            {/* Arrow */}
      ...
      <a
        ...
        className="group flex items-center justify-center w-16 h-16 bg-green-500 hover:bg-green-600 rounded-full shadow-xl shadow-green-500/40 hover:shadow-green-600/50 transition-all duration-300 hover:scale-110"
